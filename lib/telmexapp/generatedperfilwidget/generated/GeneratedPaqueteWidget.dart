...
import 'package:flutterapp/telmexapp/generatedperfilwidget/generated/GeneratedVectorWidget194.dart';

/* Frame paquete
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedPaqueteWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(context, '/GeneratedMIPAQWidget'),
      child: ClipRRect(
