...
import 'package:flutterapp/telmexapp/generatedwifiapagarwidget/generated/GeneratedVectorWidget124.dart';
import 'package:flutterapp/helpers/transform/transform.dart';

/* Frame compartir red
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedCompartirredWidget3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(context, '/GeneratedWIFIcodigoWidget'),
      child: ClipRRect(
